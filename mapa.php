...
<?php  #no olvidar dar las gracias a los del grafico del mapaaaaa ?>
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                ...
                ?>
                <h2><?php
                $user= "select username from Usuarios where id = id";
                echo"Usuario";
                ?></h2>
              </div>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-map-marker"></i> Mapa </a></li>
                </ul>
              </div>
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        ...
                        <span class="message">Aqui pondre las alertas</span>
                      </a>
                    </li>
                    <li>
...
<script>
  ...
  L.circle([-35.43555, -71.6316], 200, {
    ...
    fillColor: '#f03',
    fillOpacity: 0.5
  }).addTo(mymap).bindPopup("Sector 1.");

  L.polygon([
    [-35.43341, -71.63279],
    [-35.43355, -71.63184],
    [-35.43306, -71.6316]
  ]).addTo(mymap).bindPopup("Sector de ejemplo 2.");


  var popup = L.popup();
  function results(e){
    document.getElementById('mensaje').innerHTML='<p>Datos sobre ese sector: blahblahblah</p>';  
  }

  function onMapClick(e) {
    popup
      .setLatLng(e.latlng)
      .setContent("Punto " + e.latlng.toString())
      .openOn(mymap);
      results(e);
  }
